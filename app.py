...
# carregando dados sidebar
def build_sidebar():
    st.image("images/logoTech.png")
    ticker_list = pd.read_csv("data/tickers_inbra.csv", index_col= 0)
    ...
    end_date = st.date_input("Para", format= "DD/MM/YYYY", value= "today")
...
def build_main(tickers, prices):
    ...
    for t in prices.columns:
        ...
        if t == "Portfolio":
            colA.image("images/wallet.png")
        elif t == "IBOV":
            colA.image("images/B3-1.jpg")
        else:
